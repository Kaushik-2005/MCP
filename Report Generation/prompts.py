...
QUERY_GENERATION_PROMPT = """
                            You are an expert researcher helping to gather information for a report.
...
SECTION_PLANNING_PROMPT = """
                            You are an expert technical writer planning a report.
...
SECTION_WRITING_PROMPT = """
                            You are an expert technical writer creating content for a section of a report.
...
FINAL_REPORT_PROMPT = """
                        You are an expert technical writer finalizing a professional report.
